...
print("Distance between 0 and 1:", norm(embedded_trainX[0] - embedded_trainX[1]))

# Save embeddings
BASE_DIR = Path(__file__).resolve().parent
np.savez_compressed(BASE_DIR / "embedded_faces.npz",trainX=embedded_trainX, trainy=trainy, testX=embedded_testX, testy=testy)
print("Embeddings saved to 'embedded_faces.npz'")
